        ...
        char** argv)
{
    ...
    char* ip = MICRO_ROS_UDP_IP;
    char* port = MICRO_ROS_UDP_PORT;
...
static void shapes_demo(int argc, char** argv)
{
    rt_thread_t tid;

    tid = rt_thread_create("shapes_demo",
        shapes_demo_entry, RT_NULL,
        15000, RT_THREAD_PRIORITY_MAX/3, 20);
    ...
    {
        rt_kprintf("Failed to create uros_client thread!\n");
    }

    return;
}
MSH_CMD_EXPORT(shapes_demo,"shapes demo");
